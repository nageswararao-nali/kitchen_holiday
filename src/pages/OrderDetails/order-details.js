...
import Map from '../OrderDetails/map';
...
function DeliveryOrderDetails() {
  ...
  return (
    <div className="container order_details_page p-t-135 p-b-100">
    <div className="mb-sm-4 d-flex flex-wrap align-items-center text-head">
        <h2 className="mb-3 me-auto">Order ID #1</h2>
        <div>
                ...
                <div className="card-body">
                    <div className="steps">
                        <ul className="orders">
                            ...
                            <li>
                                <a href="/orderDetails">
                                <img src='/assets/images/review.png' width={50}/>
                                </a>
                                <h5>Give a review</h5>
                                <span>-</span>
                            </li>
                            ...
                            <div>
                                <div className="card-body d-flex align-items-center justify-content-between pb-0">
                                    <div className="d-flex align-items-center delivery-guy">
                                        <div className="me-3"><img src="/assets/images/logo_f.png" width={100} alt="" /></div>
                                        <div className='text-left'>
                                            <span>Delivery guy</span>
                                            <h5 className="mb-0 t_title">deliveryBoy</h5>
                ...
                <div className="col-xl-12">
                    <div className="card">
                        <div className="card-body p-0">
                                        ...
                                        <div className='d-flex flex-column'>
                                            <div className="media d-flex align-items-start text-left">
                                                <img style={{width: "100px"}}
                                                    ...
                                                    src="/assets/images/m_plate3.png"
                                                    alt="DexignZone"/>
                                                <div className="media-body">
                                                    <small className="mt-0 mb-1 font-w600"><a className="text-primary" href="/orderDetails">itemName + order.quantity</a></small>
                                                    <h5 className="mt-0 mb-2 mb-sm-3"><a className="text-black" href="/ecom-product-grid">itemName + order.quantity</a></h5>
                                            ...
                                            <div className='sub_item_title d-flex'><span style={{width:'25%'}}></span><h5>Sub Items</h5></div>
                                        </div>
                                        {/* { */}
                                            ...
                                            <tr >
                                                <td>
                                                    <div className="media d-flex align-items-center text-left justify-content-start">
                                                        {/* <a href="/orderDetails"> */}
                                                        <span style={{width:'25%'}}></span>
                                                            <img
                                                                style={{width: "60px"}}
                                                                className="me-3 img-fluid"
                                                            src='/assets/images/non-veg_item3.png'
                                                                alt="DexignZone"
                                                            />
                                                        {/* </a> */}
                                                        <div className="media-body">
                                                ...
                                                <td><h5 className="my-0 font-w600">x</h5></td>
                                                <td><h5 className="my-0 font-w600">$1</h5></td>
                                                <td className="d-md-none d-lg-table-cell"><h5 className="my-0 font-w600">$2</h5></td>
                                            </tr>
                                                   {/* ) */}
                                                {/*  } */}
                            ...
                            <div className='card_total_price text-center'>
                            Total Price: $280
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="card">
                        <div className="card-body">
                            <div className="text-center order-media mb-4">
                                <img src="/assets/images/avatar-01.webp"
                                    alt=""
                                />
                                <div>
                                    <h4 className="text-black mb-1 mt-1 font-w600">customerName</h4>
                            ...
                            <div className="imfo align-items-center mb-4 d-flex">
                                ...
                                <h5 className="mb-0 text-black ms-3 flex-grow-1">customerMobile</h5>
                            </div>
                            <div className="imfo align-items-center mb-4 d-flex">
